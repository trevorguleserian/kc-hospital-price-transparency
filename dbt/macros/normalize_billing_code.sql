...
{#-
  normalize_billing_code_for_storage moved to normalize_and_validate_billing_codes.sql (centralized).
  Use: {{ normalize_billing_code_for_storage('billing_code', 'billing_code_type') }} from that file.
-#}

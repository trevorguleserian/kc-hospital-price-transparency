...
mapped as (
  select
    ...
    b.hospital_name,
    b.billing_code,
    b.billing_code as billing_code_raw,
    coalesce(upper(replace(trim(cast(b.billing_code_type as string)), '-', '_')), 'UNKNOWN') as billing_code_type,
    b.description,
    b.payer_name,
    b.plan_name,
    case
...
base as (
  select
    ...
    u.hospital_name,
    u.billing_code,
    u.billing_code as billing_code_raw,
    coalesce(upper(replace(trim(cast(u.billing_code_type as string)), '-', '_')), 'UNKNOWN') as billing_code_type,
    u.description,
    u.payer_name,
    u.plan_name,
    u.rate_type,
